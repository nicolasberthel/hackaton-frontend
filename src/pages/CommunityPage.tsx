  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      ...
      <Card className="p-8 space-y-6">
        ...
        {/* Placeholder for map - in real app would use mapping library */}
        <div className="relative h-80 bg-gradient-hero rounded-lg flex items-center justify-center border-2 border-border">
          <div className="text-center space-y-2">
            <MapPin className="w-12 h-12 text-primary mx-auto" />
            <p className="text-muted-foreground">Interactive map visualization</p>
            <p className="text-sm text-muted-foreground">Showing investment distribution across regions</p>
          </div>
        </div>
